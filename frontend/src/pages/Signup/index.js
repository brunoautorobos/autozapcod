...
const useStyles = makeStyles(theme => ({
    root: {
        width: "100vw",
        height: "100vh",
        background: "linear-gradient(to right, #1cd5ff , #00008B , #0000FF)", //Cor de fundo
        display: "flex",
...
const handleNewUserMessage = newMessage => {
    window.open(
        `https://api.whatsapp.com/send?phone=5511989243450&text=${encodeURIComponent(newMessage)}`,
      "_blank"
    );
};
